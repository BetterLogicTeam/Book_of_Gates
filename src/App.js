...
function App() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      } else if (scrollTop === 10 && isScrollingDown) {
  ...
  return (
    <div className="App">
       {isScrollingDown && (
        <div className="scroll-button" onClick={()=>(handleScrollUp(),setIsScrollingDown(false))}>
          <BsArrowUpSquareFill />
        </div>
      )}
      {!isScrollingDown && (
        <div className="scroll-button" onClick={()=>(handleScrollDown(),setIsScrollingDown(true))}>
     ...
     {/* <ScrollButton direction="up" visible={showScrollUp} /> */}
     {/* <ReactScrollDown /> */}
     {/* <ScrollUpButton /> */}
     <Secone/>
     <Secthree/>
    ...
    <div className='MainApp'>
      ...
      <Footer/>
      {/* <ScrollButton direction="down" visible={showScrollDown} /> */}
    </div>
